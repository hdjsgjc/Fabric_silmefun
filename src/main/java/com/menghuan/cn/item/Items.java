...
public class Items {
    ...
    public static final Item BACKPACK_GILDED = ModItem("backpack_gilded", new BackPackGilde(new FabricItemSettings().maxCount(1)));
    ...
    public static final Item BACKPACK_WOVEN = ModItem("backpack_woven", new BackPackWoven(new FabricItemSettings().maxCount(1)));
