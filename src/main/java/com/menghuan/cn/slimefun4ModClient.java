...
import com.menghuan.cn.handher.BackPack.Screen.*;
...
public class slimefun4ModClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        HandledScreens.register(Slimefun4Mod.BackPackWovenScreeHandlerTye, BackPackWovenScreen::new);
        HandledScreens.register(Slimefun4Mod.BackPackGildedScreeHandlerTye, BackPackGildedScreen::new);
